...
public class TreeTests
{
    ...
    {
        var tree = new Tree();
        var parent = tree.Insert(NodeId.None, 0, MakeLabel("Group", Role.Group));
        var child1 = tree.Insert(parent, 0, MakeLabel("A", Role.Button));
        var child2 = tree.Insert(parent, 1, MakeLabel("B", Role.Button));
    ...
    public void RemoveSubtree()
    {
        var tree = new Tree();
        var parent = tree.Insert(NodeId.None, 0, MakeLabel("Group", Role.Group));
        var child = tree.Insert(parent, 0, MakeLabel("A", Role.Button));
        var grandchild = tree.Insert(child, 0, MakeLabel("B", Role.Button));
    ...
    public void StaleIdResolvesToNothing()
    {
        ...
        var a = tree.Insert(NodeId.None, 0, MakeLabel("A", Role.Button));
        tree.Remove(a);
        var b = tree.Insert(NodeId.None, 0, MakeLabel("B", Role.Button));
    ...
    public void PopRemovesNodes()
    {
        ...
        tree.PushLayer();
        var b = tree.Insert(NodeId.None, 0, MakeLabel("B", Role.Button));
        var c = tree.Insert(b, 0, MakeLabel("C", Role.Button));
...
public class FocusMemoryTests
{
    ...
    {
        var tree = new Tree();
        var group = tree.Insert(NodeId.None, 0, new WidgetLabel("G", Role.Group));
        var a = tree.Insert(group, 0, new WidgetLabel("A", Role.Button));
        var b = tree.Insert(group, 1, new WidgetLabel("B", Role.Button));
